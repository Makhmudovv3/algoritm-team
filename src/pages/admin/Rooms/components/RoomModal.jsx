...
export default function RoomModal({ isOpen, onClose, onSave, formData, setFormData, branches, isEditing }) {
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md overflow-hidden">
        ...
        <form onSubmit={onSave} className="p-6 flex flex-col gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Xona nomi</label>
            <input 
              type="text" 
              value={formData.name}
