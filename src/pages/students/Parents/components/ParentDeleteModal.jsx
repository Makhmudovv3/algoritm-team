...
export function ParentDeleteModal({ isOpen, onClose, onConfirm }) {
  return (
        ...
        <div className="flex items-start gap-4 p-4 bg-red-50  rounded-lg border border-red-100 ">
          ...
          <div>
            ...
            <p className="text-sm text-red-700/90  leading-relaxed">
              Siz ushbu ota-onani butunlay o'chirib tashlamoqchisiz. Uning farzandlari profilidan ham aloqa ma'lumotlari uzilishi mumkin. Bu amalni ortga qaytarib bo'lmaydi.
            </p>
          </div>
        </div>
